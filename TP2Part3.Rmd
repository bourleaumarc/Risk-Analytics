...
```
```{r}
rl_mle1 <- return.level(plot_mle, conf=0.05, return.period = c(2,5,10,20,50), do.ci=T)
rl_mle1

plot_mle2 <- fevd(as.vector(summer_night_max$night.max), method = "MLE",  type="GP", threshold = th2)
plot(plot_mle2)
```
```{r}
