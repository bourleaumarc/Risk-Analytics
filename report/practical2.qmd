...
3.  **Declustering Methods**: apply declustering algorithms to separate the data into independent clusters of exceedances and intervening non-exceedances. A straightforward declustering method, such as iterating through the data with a for loop, to identify and group extreme precipitation events by their occurrence in distinct years, is simple and effective. It separates data into clusters of exceedances and non-exceedances, providing a clear delineation of extreme events.
...
threshrange.plot(niveau$Wert, r = c(325, 329), nint = 16) # Chose 327
