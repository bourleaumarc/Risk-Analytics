...
From the plot, we can observe that there are a total of 11 data points over the threshold of 140 (represented by the red line). The highest record sea level, which occured in 1966, stands out as the peak value in the dataset.
...
Overall, the confidence intervals show that the values range from 124 to 146, which doesn't provide a very good fit for the model. This may be due to the lack of historical data or that linear models do not capture effectively the changes of the sea-level. 
...
-------------------------------------------------------------ASK HOW CAN WE VARY THE LOCATION PARAMETER --------------------------------------------------------------------------------------------------------------------------
