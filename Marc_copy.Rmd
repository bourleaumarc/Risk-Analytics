...
Question A: assess the stationarity of the data. 
...
- summary statistics: mean across time periods 
```{r}
...
#QUESTION B)
Log returns can help make financial time series data more stationary.
Meaningful and standardized way to express returns, make data more amenable to analysis and modeling,
